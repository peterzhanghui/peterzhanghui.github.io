...
![修改前界面截图](http://www.jiatt.top/2025/04/25/cursor/image_1.png)

修改后：

![修改后界面截图](http://www.jiatt.top/2025/04/25/cursor/image_2.png)

### 1.2 VSCode 

从VSCode迁移，相关配置

![VSCode迁移配置](http://www.jiatt.top/2025/04/25/cursor/image_3.png)

### 1.3 WebStorm 

![WebStorm界面](http://www.jiatt.top/2025/04/25/cursor/image_4.png)
...
![收费版本对比](http://www.jiatt.top/2025/04/25/cursor/image_5.png)
...
![使用模式选择](http://www.jiatt.top/2025/04/25/cursor/image_6.png)
...
![不同模型限制对比](http://www.jiatt.top/2025/04/25/cursor/image_7.png)
...
![个人规则配置界面](http://www.jiatt.top/2025/04/25/cursor/image_8.png)
...
*   生产环境规范（禁用mock）  
    ![项目规则设置界面](http://www.jiatt.top/2025/04/25/cursor/image_9.png)
...
![Notepad功能开启](http://www.jiatt.top/2025/04/25/cursor/image_10.png)

使用示例：

![Notepad使用示例](http://www.jiatt.top/2025/04/25/cursor/image_11.png)
...
![MCP架构图](http://www.jiatt.top/2025/04/25/cursor/image_12.jpeg)
...
![filesystem MCP功能](http://www.jiatt.top/2025/04/25/cursor/image_13.png)

**sequentialthinking：**支持复杂问题的分步拆解、动态调整、分支推演和多方协作

![sequentialthinking MCP功能](http://www.jiatt.top/2025/04/25/cursor/image_14.png)
...
![Git修改生成测试用例](http://www.jiatt.top/2025/04/25/cursor/image_15.png)

**使用联网功能**：使用`@web` ，快速获取最新的信息。

**使用 checkpoint 一键回滚：**

![checkpoint一键回滚](http://www.jiatt.top/2025/04/25/cursor/image_16.png)

**快捷键**: 熟练使用 `Cmd/Ctrl+K` (内联编辑/终端生成), `Cmd/Ctrl+L` (聊天) 等核心快捷键。

终端使用自然语言生成命令

![终端自然语言生成命令](http://www.jiatt.top/2025/04/25/cursor/image_17.png)

代码中使用，针对选中代码快速提问

![代码快速提问](http://www.jiatt.top/2025/04/25/cursor/image_18.png)
...
![预先沟通确认需求](http://www.jiatt.top/2025/04/25/cursor/image_19.png)

**关注边界**: 在 AI 生成代码后，注意检查是否考虑了边界情况、错误处理以及对现有代码的影响范围。

建议在Rules中添加全局规则

![Rules全局规则配置](http://www.jiatt.top/2025/04/25/cursor/image_20.png)

**Git Commit Message**: 让 AI 基于暂存区的代码变更自动生成规范的 Git Commit Message。

![Git Commit Message生成](http://www.jiatt.top/2025/04/25/cursor/image_21.png)

最好可以结合 Cursor Rules 一起使用：

![结合Cursor Rules使用](http://www.jiatt.top/2025/04/25/cursor/image_22.png)
...
![自动化执行配置](http://www.jiatt.top/2025/04/25/cursor/image_23.png)

**任务完成通知**: 在设置中开启任务完成声音提示，方便异步等待 AI 处理结果。

![任务完成通知设置](http://www.jiatt.top/2025/04/25/cursor/image_24.png)
...
![理财产品管理页面原型](http://www.jiatt.top/2025/04/25/cursor/image_25.png)

#### 具体实现

提示词

![实现提示词](http://www.jiatt.top/2025/04/25/cursor/image_26.png)

结果页面

![实现结果页面](http://www.jiatt.top/2025/04/25/cursor/image_27.png)
...
![原有流程图](http://www.jiatt.top/2025/04/25/cursor/image_28.png)

提示词：

![流程优化提示词](http://www.jiatt.top/2025/04/25/cursor/image_29.png)

结果：

![优化后的双录流程图](http://www.jiatt.top/2025/04/25/cursor/image_30.png)
...
```markdown
# 方式1：相对路径（推荐）
![图片描述](http://www.jiatt.top/2025/04/25/cursor/image1.png)
...
# 在文章中使用 ![描述](http://www.jiatt.top/2025/04/25/cursor/filename.jpg)
```
